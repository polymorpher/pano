...
export const Commands: Record<CommandKeys, Command> = {
  ...
  portfolio: { short: 'p', full: 'portfolio', desc: 'show your deposited assets collateral value, open positions, margin requirement, and net value of each position', wallet: true, submenu: true },
