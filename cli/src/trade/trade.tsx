...
export const LegMaker = React.forwardRef<LegMakerRef, LegMakerProps>(
  (
    ...
    const currentPrice =
      quoteAsset === 'token0'
        ? chosenPairInfo.priceInverse
        : chosenPairInfo.price
          ...
          <MultiChoiceSelector
            ...
            intro={
              <Box marginY={1} flexDirection={'column'}>
                ...
                <Text>
                  - prices is quoted in that asset, against the other asset
                  (i.e. base asset)
                </Text>
                <Text>
          ...
          <AmountSelector
            intro={
              <>
                ...
                <Text>
                  - Premium (profit) is accrued when ${baseAssetInfo.symbol}{' '}
                  price stays within range around strike price
                </Text>
                <Text>
